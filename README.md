...
- **普通档**：**α-β**（`pickBestMoveMinimax(board, 3)`）。
- **困难档**：强候选经 **α-β** 筛选后，在根节点做多局 **随机 rollout** 估计胜率（`pickBestMoveHardHybrid`），**无**神经网络。
- **参考仓库**：[gomoku_rl](https://github.com/guokezhen999/gomoku_rl)（深度强化学习方向，Python/PyTorch）；[gobang](https://github.com/lihongxun945/gobang)（经典 α-β，JavaScript）。
